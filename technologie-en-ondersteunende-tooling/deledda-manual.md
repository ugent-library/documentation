...
Books and other works are scanned by Geert or Rik.
...
- `/mnt/data01/01_ready/emiherma`: Emilie is the quality manager (see below) who
...
A quality manager (read: Emilie) will now do additional checks
